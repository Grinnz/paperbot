...
my %command = (
	...
	'ping' => { func => 'cmd_ping', access => ACCESS_NONE, on => 1, strip => 0 },
	...
	'fight' => { func => 'cmd_fight', access => ACCESS_NONE, on => 1, strip => 1 },
	...
	'xkcd' => { func => 'cmd_xkcd', access => ACCESS_NONE, on => 1, strip => 1 },
...
sub say_weather {
	...
	if (defined $weather) {
		...
		if (defined $feelslike_f or defined $feelslike_c) {
			my $feelslike_str = "Feels like ${feelslike_f}°F / ${feelslike_c}°C";
	...
	if (defined $weather) {
		...
		foreach my $i (1..$max_days) {
			...
			if (defined $high) {
				...
				my $high_str = "High ${high_f}°F / ${high_c}°C";
			...
			if (defined $low) {
				...
				my $low_str = "Low ${low_f}°F / ${low_c}°C";
